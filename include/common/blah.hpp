 ...
 * @date   Mon Sep 20 16:15:15 2010
 *
 * @brief blah : log include file
 *
 *
 */
...
#define LOG_ORG BLAH_TRANSIENT_LOG("log")
#define LOG LOG_ORG<< "[ File "<< __FILE__ <<  " ] [ Line "<< __LINE__<<" ] : "<<"\n\t"
