 ...
 * @date   Mon Sep 20 16:14:21 2010
 *
 * @brief  blah construction
 *
 *
 */
...
#error "blah doesn't know how to represent thread identifiers on your platform. Define BLAH_NO_THREAD_SUPPORT if you don't care!"
    ...
    progression filter::operator() (const entry &e, std::string &text) const
    {
        return f_ ? f_->filt(e, text) : carry_on;
    }
...
#error "localtime() may not be threadsafe on this platform. Comment-out this line if you know better or don't care!"
    ...
    blah::progression append_thread(const blah::entry &e, std::string &text)
    {
        ...
        e_(other.e_)
    {
        ...
        blah::push_filter(&append_thread);
    }
