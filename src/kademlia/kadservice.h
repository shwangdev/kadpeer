...
namespace kad{
    ...
    typedef boost::function< int(Contact, const bool&) > add_contact_function;

    typedef boost::function< void(const int&, const std::vector<Contact>&,std::vector<Contact>*) > get_random_contacts_function;

    typedef boost::function< bool(const KadID&, Contact*) > get_contact_function;

    typedef boost::function< void(const KadID&, std::vector<Contact>*, const std::vector<Contact>&) > get_closestK_function;
